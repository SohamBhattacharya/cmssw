...
void TMVARegression( TString myMethodList = "" )
{
    ...
    //dataloader->AddVariable("slimmedEle_isoDR0p3_sumETratio" , "I_{0.3}", "");
    dataloader->AddVariable("slimmedEle_isoDR0p3_sumETratio_cleanedDT3sigma" , "I^{cleaned}_{0.3}", "");
    ...
    dataloader->AddTarget("gsfEleFromTICL_matchedGenEl_E", "E_{gen-ele}");
    ...
    std::string sourceFileName = "sourceFiles/TreeMaker_SingleElectron_PT2to200_Phase2HLTTDRWinter20DIGI-PU200_110X_mcRun4_realistic_v3_ext2-v2_GEN-SIM-modRECO/TreeMaker_SingleElectron_PT2to200_Phase2HLTTDRWinter20DIGI-PU200_110X_mcRun4_realistic_v3_ext2-v2_GEN-SIM-modRECO.txt";
    ...
    //std::vector <TFile*> v_inFile;
    
    TChain *regChain = new TChain("treeMaker/tree");
    ...
    //TTree *regTree = (TTree*) regChain->GetTree();
    ...
    TCut mycut = "gsfEleFromTICL_pT > 15 && gsfEleFromTICL_genEl_minDeltaR < 0.5";
    //TCut mycut = "gsfEleFromTICL_pT > 15 && gsfEleFromTICL_E > 100 && gsfEleFromTICL_E < 350 && gsfEleFromTICL_genEl_minDeltaR < 0.5";
    ...
    //dataloader->PrepareTrainingAndTestTree(mycut, "nTrain_Regression=65000:nTest_Regression=0:SplitMode=random:!V" );
    ...
    if (Use["PDEFoam"])
        factory->BookMethod( dataloader,  TMVA::Types::kPDEFoam, "PDEFoam",
                    ...
                    //"!H:!V:MultiTargetRegression=F:TargetSelection=Mpv:TailCut=0.001:VolFrac=0.5:nActiveCells=500:nSampl=2000:nBin=5:Compress=T:Kernel=None:Nmin=10:VarTransform=None" );
