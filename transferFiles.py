...
parser.add_argument(
    "--rsyncFlags",
    help = "rsync flags: \" -<flag>\". Note the space before \"-\".",
    #nargs = "*",
    type = str,
    default = "",
    required = False,
...
l_file = [
    ...
    "RecoEcal/EgammaClusterAlgos/interface/PFECALSuperClusterAlgo.h",
    "RecoEcal/EgammaClusterAlgos/src/PFECALSuperClusterAlgo.cc",
    
    "RecoEcal/EgammaClusterProducers/python/particleFlowSuperClusterECAL_cfi.py",
    
    "RecoEcal/EgammaClusterProducers/interface/PFECALSuperClusterProducer.h",
    "RecoEcal/EgammaClusterProducers/src/PFECALSuperClusterProducer.cc",
    
    "RecoEcal/EgammaCoreTools/interface/Mustache.h",
    "RecoEcal/EgammaCoreTools/src/Mustache.cc",
]
