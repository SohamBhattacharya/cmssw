...
pltQty_temp = plotQuantity()
pltQty_temp.isMultiLayer = False
pltQty_temp.plotStr = "gsfEleFromTICL_R2p8 : gsfEleFromTICL_E/invTar"
#pltQty_temp.cutStr = "genEl_pT[0] < 30"
#pltQty_temp.weightStr = "multiClus_ET[multiClus_HGCalEEM_EsortedIndex[0]]"
pltQty_temp.nBinX = 200
pltQty_temp.createXmin = 0
pltQty_temp.createXmax = 1000
pltQty_temp.nBinY = 50
pltQty_temp.createYmin = 0.5
pltQty_temp.createYmax = 1.0
#pltQty_temp.normalize = False
#pltQty_temp.scale = 100
pltQty_temp.xMin = 0
...
pltQty_temp.yLabelSizeScale = 0.9
pltQty_temp.xTitle = "E_{gen-ele}"
pltQty_temp.yTitle = "R_{2.8}"
pltQty_temp.zTitle = "a.u."
pltQty_temp.extraText = "#splitline{#scale[1.3]{Phase-II PU200}}{#scale[1.3]{HGCal EE}}"
pltQty_temp.extraTextX = 500
pltQty_temp.extraTextY = 0.6
pltQty_temp.plotStyle = "colz"
pltQty_temp.outFileName = "gsfEleFromTICL-R2p8_vs_genEl-E"
pltQty_temp.outDir = "plots/vars_EgRegresTrainerLegacy"
l_plotQuantity2D.append(pltQty_temp)


pltQty_temp = plotQuantity()
pltQty_temp.isMultiLayer = False
pltQty_temp.plotStr = "gsfEleFromTICL_E/invTar : abs_gsfEleFromTICL_eta_"
#pltQty_temp.cutStr = "genEl_pT[0] < 30"
#pltQty_temp.weightStr = "multiClus_ET[multiClus_HGCalEEM_EsortedIndex[0]]"
pltQty_temp.nBinX = 50
pltQty_temp.createXmin = 1.5
...
pltQty_temp.yLabelSizeScale = 0.9
pltQty_temp.xTitle = "E_{gen-ele}"
pltQty_temp.yTitle = "#||{#eta_{TICL-ele}}"
pltQty_temp.zTitle = "a.u."
pltQty_temp.extraText = "#splitline{#scale[1.3]{Phase-II PU200}}{#scale[1.3]{HGCal EE}}"
pltQty_temp.extraTextX = 1.6
pltQty_temp.extraTextY = 950
pltQty_temp.plotStyle = "colz"
pltQty_temp.outFileName = "gsfEleFromTICL_genEl-E_vs_eta"
pltQty_temp.outDir = "plots/vars_EgRegresTrainerLegacy"
l_plotQuantity2D.append(pltQty_temp)
...
pltQty_temp = plotQuantity()
pltQty_temp.isMultiLayer = False
pltQty_temp.plotStr = "invTar : abs_gsfEleFromTICL_eta_"
pltQty_temp.cutStr = "gsfEleFromTICL_R2p8 > 0.8 && gsfEleFromTICL_R2p8 < 0.85"
#pltQty_temp.weightStr = "multiClus_ET[multiClus_HGCalEEM_EsortedIndex[0]]"
pltQty_temp.nBinX = 50
pltQty_temp.createXmin = 1.5
pltQty_temp.createXmax = 3.0
...
pltQty_temp.createYmin = 0.0
pltQty_temp.createYmax = 1.5
#pltQty_temp.normalize = False
#pltQty_temp.scale = 100
pltQty_temp.xMin = 1.5
pltQty_temp.xMax = 3.0
pltQty_temp.yMin = 0.7
pltQty_temp.yMax = 1.3
#pltQty_temp.logZ = True
#pltQty_temp.nDivisionsX = [5, 5, 0]
pltQty_temp.yLabelSizeScale = 0.9
pltQty_temp.xTitle = "#||{#eta_{TICL-ele}}"
pltQty_temp.yTitle = "E_{TICL-ele} / E_{gen-ele}"
pltQty_temp.zTitle = "a.u."
pltQty_temp.extraText = "#splitline{#splitline{#scale[1.3]{Phase-II PU200}}{#scale[1.3]{HGCal EE}}}{0.8 < R_{2.8} < 0.85}"
pltQty_temp.extraTextX = 1.6
pltQty_temp.extraTextY = 1.28
pltQty_temp.plotStyle = "colz"
pltQty_temp.outFileName = "gsfEleFromTICL-corrResp_vs_eta_R2p8-0p80to0p85"
pltQty_temp.outDir = "plots/vars_EgRegresTrainerLegacy"
l_plotQuantity2D.append(pltQty_temp)
...
pltQty_temp = plotQuantity()
pltQty_temp.isMultiLayer = False
pltQty_temp.plotStr = "gsfEleFromTICL_R2p8 : abs_gsfEleFromTICL_eta_"
#pltQty_temp.cutStr = "genEl_pT[0] < 30"
#pltQty_temp.weightStr = "multiClus_ET[multiClus_HGCalEEM_EsortedIndex[0]]"
pltQty_temp.nBinX = 50
pltQty_temp.createXmin = 1.5
...
pltQty_temp.extraTextY = 0.6
pltQty_temp.plotStyle = "colz"
pltQty_temp.outFileName = "gsfEleFromTICL-R2p8_vs_eta"
pltQty_temp.outDir = "plots/vars_EgRegresTrainerLegacy"
l_plotQuantity2D.append(pltQty_temp)
