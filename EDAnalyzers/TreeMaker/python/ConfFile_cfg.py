...
label_TICLpfCluster = cms.untracked.InputTag("particleFlowClusterHGCalFromMultiCl", "", "RECO")
label_TICLpfClusterAssoc = cms.untracked.InputTag("particleFlowSuperClusterHGCalFromMultiCl", "PFClusterAssociationEBEE", "RECO")
...
if (options.rerunTICL) :
    ...
    label_TICLpfCluster = cms.untracked.InputTag("particleFlowClusterHGCalFromTICL", "", "Demo")
    label_TICLpfClusterAssoc = cms.untracked.InputTag("particleFlowSuperClusterHGCalFromTICL", "PFClusterAssociationEBEE", "Demo")
...
process.treeMaker = cms.EDAnalyzer(
    ...
    label_TICLpfCluster = label_TICLpfCluster,
    label_TICLpfClusterAssoc = label_TICLpfClusterAssoc,
...
if (options.modTICLele) :
    ...
    if (options.rerunTICL and options.modTICLeleWithRerunTICL) :
        ...
        process.particleFlowClusterHGCalFromMultiCl.initialClusteringStep.clusterSrc = cms.InputTag(
