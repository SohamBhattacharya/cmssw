...
static constexpr auto s_tag = "[EnergySharedTICLmultiClusterProducer]";

TEST_CASE("Standard checks of EnergySharedTICLmultiClusterProducer", s_tag) {
  const std::string baseConfig{
R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("EnergySharedTICLmultiClusterProducer"
