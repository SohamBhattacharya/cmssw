...
)
{
    ...
    //printf("HGCalShowerShapeHelper::getPCAwidths(...): minHitE %0.2f, nHitsPassed %d, det %0.4e \n", minHitE_, (int) hitEnergiesWithFracs_.size(), covMat.Determinant());
    //printf("HGCalShowerShapeHelper::getPCAwidths(...): minHitE %0.2f, nHitsPassed %d, totalW %0.4e \n", minHitE_, (int) hitEnergiesWithFracs_.size(), totalW);
    //covMat.Print();
